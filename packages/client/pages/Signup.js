      ...
      <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center">
        <div className='bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-4xl'>
          <div className='w-3/5 p-5'>
            <div className='py-3'>
              <h2 className='text-3xl font-bold text-green-600'>Create your User's Account</h2>
              ...
              <div className='bg-gray-100 w-64 p-1 flex items-center'><FaRegUser className='text-gray-400 m-2' />
                ...
                <a href="#" className='border-2 border-green-500 rounded-full px-12 py-2 inline-block font-semibold hover:bg-black hover:text-white mt-5'>Sign Up</a>
              </div>
            </div>
          </div>
          <div className='w-2/5 bg-green-300 text-black font-semibold rounded-tr-2xl rounded-br-2xl px-2'>
            ...
            <div className='mt-12'>
            <Image
            src = "/shutterstock_551163163.jpg"
            alt="Live E-commerce"
            width={310}
            height={190}
            /></div>
