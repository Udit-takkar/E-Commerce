...
export function GridItemFour({ children, className = '' }) {
  return (
...
export function GridItemSix({ children, className = '' }) {
  return (
...
export function GridItemEight({ children, className = '' }) {
  return (
    <div
...
export function GridItemTwelve({ children, className = '' }) {
